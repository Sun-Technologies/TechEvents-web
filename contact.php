<?php 
	...
	#Your e-mail address
	define("__TO__", "imailTahir@gmail.com");

	#Message subject
	define("__SUBJECT__", "Bangalore It events");
		...
		if($name == '') {
			...
			<body>
			  <table style="width: 500px; font-family: arial; font-size: 14px;" border="1">
				...
				<tr style="height: 32px;">
				  <th align="right" style="width:150px; padding-right:5px;">Organization:</th>
				  <td align="left" style="padding-left:5px; line-height: 20px;">'. $oname .'</td>
				</tr>
				<tr style="height: 32px;">
